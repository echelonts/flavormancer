...
## 3. Aroma — 16 descriptor heads from public odor text
...
3. **`train_aroma.py`** trains one RandomForest per descriptor (on fingerprint + descriptors) and
   **keeps only the heads that clear CV-AUROC ≥ 0.70** — an honest bar. **16 heads** survive
   (citrus, floral, minty, almond, fatty, petroleum, earthy, medicinal, sulfurous, camphor,
   fruity, fishy, garlic, ethereal, ammoniacal, pungent), 0.73–0.97.
